...
var Postmedia = { "Properties": {"domain":"","userAgents":["mozilla","msie","webkit","ipad"],"mobileAgents":["iphone","ipod","android"],"isMobile":false,"isIpad":false,"isModal":false},
                    "adConfig": {
                        "site": "mg_habsio.com",
                        "async": true,
                        "sra": true,
...
<script language="javascript" type="text/javascript" src="/js/cdc-adserver.js"></script>
<script language="javascript" type="text/javascript" src="/js/cdc-data.js"></script>
<script language="javascript" type="text/javascript" src="/js/cdc-ooyala.js"></script>
<script language="javascript" type="text/javascript" src="/js/cdc-utils.js"></script>
	...
	<div id="container">
			...
			<div id="top_banner" align="center">
		     	...
		     	<div class="advertisement">
			     	...
			     	<?php  pn_dfp_ads() -> call_ad('leaderboard');  ?>
