...
<!--OOYALA VIDEO ID-->
<!--
<?php $ooyala_id = get_post_meta($post->ID, 'ooyala_id', true); ?>

<?php echo '
<div class="entry-video-content"><script type="text/javascript" src="http://player.ooyala.com/v3/59cb33e9fef475d9258e9399aecebac"></script>' ?>

<?php echo '<div id="ooyalaplayer">' ?>
<?php echo '</div>' ?>

<?php echo '<script type="text/javascript">// <![CDATA[
OO.ready(function() { OO.Player.create("ooyalaplayer",' . $ooyala_id . '); });
// ]]></script>' ?>
<?php echo '</div></br></br>'?>
<?php echo '<style>
.post-thumb{
...
<script type="text/javascript">
onload=function(){
var emptydiv=document.getElementById('ooyalaplayer');
if(!emptydiv.hasChildNodes()){emptydiv.style.display='none'}
}
</script>
-->
...
<!--OOYALA VIDEO ID BACKUP-->

<?php $ooyala_id = get_post_meta($post->ID, '_ooyala_id', true);?>
<!--
...
<?php echo '<script type="text/javascript">// <![CDATA[
OO.ready(function() { OO.Player.create("ooyalaplayer",' . $ooyala_id['name'] . '); });
// ]]></script>' ?>
<?php echo '</div></br></br>'?>
-->
<?php echo '<style>
...
//var ooyala_id = "<?php echo $ooyala_id; ?>"    
      ...
      var url = 'http://app.staging.canada.com/Video/video.svc/loader/?';
