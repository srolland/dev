...
/* 					font-weight: bold; */
			...
			<h2 style="color:#DA0000; font-family:verdana, arial, sans-serif; font-size:16px;"><strong>Latest</strong> Episode:</h2>
			</br>
			...
			<div id="latest-post" class="rounded clearfix">
				...
				<div class="post-thumb">
					<a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php printf(__('Permanent Link to %s', 'framework'), get_the_title()); ?>"><?php the_post_thumbnail('show-big'); /* post thumbnail settings configured in functions.php */ ?></a>
				</div>
				<?php } else if ( is_category('Videos') ) { /* if post has post thumbnail */ 
				...
				<div class="post-thumb">
					<a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php printf(__('Permanent Link to %s', 'framework'), get_the_title()); ?>">
						<div style="width:285px; height:280px; overflow:hidden; float:left; margin: 0 20px 0 0;">
                        <img src="<?php echo $thumb ?>" style="display:inline; margin-left:-90px; margin-top:-40px;"/>
                    	</div>
                	</a>       
				</div>
				<?php } ?>
			...
			<h2 style="color:#DA0000; font-family:verdana, arial, sans-serif; font-size:16px;"><strong>Previous</strong> Episodes:</h2>
			</br>
			...
			<?php else : ?>
				...
				<div class="post-container clearfix">
					...
					$thumbnail = get_post_meta(get_the_ID(), 'thumbnail_url');
      				$thumb = $thumbnail[0];
				?>
				<div class="post-thumb" style="border: 1px solid #EEEEEE; width:83px; height:83px; float:left; margin: 0 10px 0 0;">
					<a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php printf(__('Permanent Link to %s', 'framework'), get_the_title()); ?>" style=" display:block; width:75px; height:75px; overflow:hidden; margin:4px;">
						<!--div style="margin:4px;  overflow:hidden; ">	
                        <div style="width:73px; height:73px; overflow:hidden; float:left; margin: 0 10px 0 0;"-->
                        <img src="<?php echo $thumb ?>" style="display:inline; margin-left:-30px; margin-top:-18px; width:140px; height:104px;"/>
                        <!--/div>
                    	</div -->
                	</a>  
				</div>
