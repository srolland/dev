					<!-- BEGIN #cateory-right-summary .category-block-summary -->
					<div id="category-right-summary" class="category-block-summary alignright">
						
						<?php /* Category credentials */
    					$category_name = $tz_cat_four_select;
						...
						$tz_cat_four_posts = new WP_Query(); $tz_cat_four_posts->query('caller_get_posts=1&posts_per_page=' . $tz_cat_four_number . '&cat=' . $category_id . ''); ?>
						<?php while ($tz_cat_four_posts->have_posts()) : $tz_cat_four_posts->the_post(); ?>
						...
						<?php endwhile; /* end category four list */ ?>
