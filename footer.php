...
<a href="<?php bloginfo( 'url' ); ?>"><?php bloginfo( 'name' ); ?></a>: Absolutely everything about the Montreal Canadiens For editorial inquiries, contact Gazette sports editor <a href="mailto:scowan@montrealgazette.com">Stu Cowan</a>. For advertising inquiries, please contact your <a href="mailto:gazadv@montrealgazette.com">Gazette sales representative</a>. &copy; <?php echo date("Y"); ?> The Gazette, a division of Postmedia Network Inc. All rights reserved. Unauthorized distribution, transmission or republication strictly prohibited. Terms and Conditions Privacy Statement
...
<script language='JavaScript' type='text/javascript' src='http://www.montrealgazette.com/js/account_habsinsideout_s_code.js'></script>
<script language='JavaScript' type='text/javascript' src='http://www.canada.com/js/global_s_code.js'></script>
<script language='JavaScript' type='text/javascript' src='http://www.montrealgazette.com/js/local_habsinsideout_s_code.js'></script>
...
//--></script><noscript><img src="http://canwest.112.2o7.net/b/ss/canwestglobal,canhabs/1/H.25.4--NS/0" height="1" width="1" border="0" alt="" /></noscript><!--/DO NOT REMOVE/-->
...
<script>
  ...
  ga('create', 'UA-17214408-10', 'hockeyinsideout.com');
  ga('send', 'pageview');
